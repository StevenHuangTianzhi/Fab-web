...
public class SingleGenreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//String query = "SELECT * from stars_in_movies, stars, movies WHERE stars.id = stars_in_movies.starId and movies.id = stars_in_movies.movieId and name = '" + id + "'";
			//String query = "SELECT * from genres_in_movies, genres, movies WHERE genres.id = genres_in_movies.genreId and movies.id = genres_in_movies.movieId and name = '" + id + "'";
			String query = "SELECT * from genres_in_movies, genres, movies WHERE genres.id = genres_in_movies.genreId and movies.id = genres_in_movies.movieId and name = ?";
